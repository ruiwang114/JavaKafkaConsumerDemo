...
import io.netty.example.http.websocketx.initializer.OldWebSocketServerInitializerSSL;
 ...
 * </ul>
 */
public final class OldWebSocketServerSSL {
...
//        kafkaSend(producer,"test");
        ...
        int port= Global.wssServicePort;
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new OldWebSocketServerInitializerSSL(producer));
